//package app.duss.easyproject.presentation.ui.picker
//
//
...
//
//        @Serializable
//        data class ItemConfig(val searchValue: String? = "", val selected: List<Item>) : Configuration()
//
//        @Serializable
//        data class CompanyConfig(val searchValue: String? = "", val filter: CompanyFilter) : Configuration()
//
//        @Serializable
//        data class PersonConfig(val searchValue: String? = "", val selected: List<Person>) : Configuration()
//
//        @Serializable
//        data class UserConfig(val searchValue: String? = "", val selected: List<User>) : Configuration()
//
//    }
//
//}